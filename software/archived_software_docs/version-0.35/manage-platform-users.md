...
Review the default roles and permissions in the [default Houston API configuration](https://github.com/astronomer/astronomer-docs-resources/blob/main/software/software_configs/0.35/default.yaml) and determine the following:
