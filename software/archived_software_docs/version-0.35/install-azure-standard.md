...
This guide describes the steps to complete an example Astronomer Software install on Azure to deploy and scale [Apache Airflow](https://airflow.apache.org/) on a [Microsoft Azure Kubernetes Service](https://azure.microsoft.com/en-us/services/kubernetes-service/) (AKS) cluster.
...
<Warning>Astronomer Software is not compatible with Azure Single Server.</Warning>
