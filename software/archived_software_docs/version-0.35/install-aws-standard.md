...
This guide describes the steps to complete an example Astronomer Software install on Amazon Web Services (AWS), where you can deploy and scale [Apache Airflow](https://airflow.apache.org/) within an AWS [Elastic Kubernetes Service](https://aws.amazon.com/eks/) (EKS) cluster.
