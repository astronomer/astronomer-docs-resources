...
For other compatibility considerations, see [Step 5: Upgrade Airflow DAGs](https://airflow.apache.org/docs/apache-airflow/stable/howto/upgrading-from-1-10/index.html#step-5-upgrade-airflow-dags) in Apache Airflow documentation.
