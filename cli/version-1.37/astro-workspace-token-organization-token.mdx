...
Manage Organization-level API tokens within a specific Workspace. See [Assign an Organization API token to a Workspace](/astro/workspace-api-tokens#assign-an-organization-api-token-to-a-workspace).
