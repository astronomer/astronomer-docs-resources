...
You can use this command to invite multiple users to a Workspace at a time. See [Add a group of users to Astro using the Astro CLI](/astro/manage-organization-users#add-a-group-of-users-to-astro-using-the-astro-cli).
