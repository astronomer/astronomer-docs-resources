...
Added support for [Astro Private Cloud 1.0](https://www.astronomer.io/docs/astro-private-cloud/v-1-x/astro-private-cloud-overview), including the ability to push images and dags to separate data plane clusters.
...
<Info title="Preview"> This feature is in [Preview](/astro/feature-previews). </Info>

Added the following commands so that you can work with the [Astro IDE](https://www.astronomer.io/docs/astro/cli/astro-ide) from the Astro CLI:
