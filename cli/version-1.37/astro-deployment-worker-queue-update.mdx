...
Update the settings for an existing [worker queue](/astro/configure-worker-queues) in a Deployment on Astro. This is functionally identical to updating the settings of a worker queue in the Astro UI.
