...
<Tabs>
<Tab title="Astro">
Show [Airflow component logs](/astro/view-logs#view-airflow-component-logs-in-the-astro-ui) over the last 24 hours for a given Deployment on Astro. These are the same logs that appear in the **Logs** tab of the Astro UI.
