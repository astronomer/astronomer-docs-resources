...
For more information about how to use Deployment files, see [Manage Deployments as Code](/astro/manage-deployments-as-code).
...
See [Template file contents](/astro/deployment-file-reference) for all possible values to return.
