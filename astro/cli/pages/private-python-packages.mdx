...
<Info>Deploying a custom Runtime image with a CI/CD pipeline requires additional configurations. For an example implementation, see the GitHub Actions CI/CD templates for [Astro](../ci-cd-templates/github-actions-template) and [Astro Private Cloud](https://www.astronomer.io/docs/software/ci-cd#github-actions-cicd).</Info>
