...
| `-d`, `--dags`            | Deploy only your `dags` directory. See [dag-only deploys](../deploy-dags)                                                                                        | None                                                             |
...
[Deploy code](../deploy-code) to a Deployment on Astro Private Cloud.
