...
Create a [worker queue](/astro/configure-worker-queues) in a Deployment on Astro. This command is functionally identical to creating a worker queue in the Astro UI.
